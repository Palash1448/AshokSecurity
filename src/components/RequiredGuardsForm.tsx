...
import { guardRequestsService, GuardRequestData } from "@/services/firebaseService";
...
// Form data type matches the service's expected input
type RequiredGuardsFormData = Omit<GuardRequestData, 'id' | 'submittedAt' | 'status'>;
...
const RequiredGuardsForm = () => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    console.log('Submitting guard request:', formData);

    try {
      const result = await guardRequestsService.create(formData);
      console.log('Guard request submitted successfully:', result);
...
export default RequiredGuardsForm;
